...
import { NoteCanvas } from '../../student/ai-notes/NoteCanvas.jsx';
import { adminGetAiNote, adminUpdateAiNote, adminGenerateAiNotes, adminGetCourses, adminGetTopics, adminGetSubtopics } from '../../../api/aiNotes.api.js';
import { createLesson, updateLesson } from '../../../api/lessons.api.js';
...
export function AdminAiNotesEditorPage({
  ...
  async function handlePublish() {
    ...
    try {
      ...
      console.error('[Publish] save error:', err?.response?.status, err?.response?.data, err?.message);
