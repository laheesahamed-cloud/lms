...
} from '../../../../shared/api/lessons.api.js';
...
const notesOutlineButtonClass = 'inline-flex min-h-8 shrink-0 touch-manipulation items-center rounded-lg border border-line-soft bg-surface-card px-3 text-left text-[11.5px] font-extrabold text-ink-muted transition-[background,border-color,color,transform] duration-150 ease-[var(--ease-out)] hover:border-brand-primary/22 hover:text-ink-strong focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-primary/15 active:scale-[0.98]';
