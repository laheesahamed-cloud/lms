const INTERNAL_ROUTE_PATTERNS = [
  /^\/$/,
  /^\/(?:login|register|pending|profile|dashboard|courses|structure|users|questions|quizzes|exams|subscriptions|billing|bookmarks|notifications|planner|doubts|flashcards|notes|ai-notes|results|review|announcements|reports|setup|settings)(?:\/|$|\?|#)/,
