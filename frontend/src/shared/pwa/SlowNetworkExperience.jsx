...
export function SlowNetworkExperience({ forceVisible = false, previewClassName = '' }) {
  ...
  if (!forceVisible && !showOverlay) {
    return null;
  }

  return (
    <aside
      className={cx(slowUi.rootBase, previewClassName ? slowUi.rootPreview : slowUi.rootLive, previewClassName)}
      aria-live="polite"
      aria-atomic="true"
    >
