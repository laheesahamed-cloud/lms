...
export declare const DEFAULT_PLAN_BLUEPRINTS: readonly [{
    ...
    recommended: 0 | 1;
    status: string;
    featureKeys: string[] | readonly string[];
} | {
    slug: string;
    name: string;
    description: string;
    regularPrice: number;
    offerPrice: 990 | 3990 | 8990 | 14990 | 390 | 2490 | 490 | 1290 | 2990 | 4990 | 690 | 1790 | 6990 | 1990 | 4490 | 7990 | 890 | 5490 | 1190 | 10990 | 5990 | 9990 | 3490 | 7490 | 12990 | 1490;
    offerEnabled: number;
    currency: string;
    durationDays: 7 | 30 | 90 | 180;
    sortOrder: number;
