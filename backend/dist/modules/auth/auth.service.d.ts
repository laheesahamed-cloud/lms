...
export declare class AuthService {
    ...
    loginWithApple(appleLoginDto: AppleLoginDto): Promise<{
        ok: boolean;
        sessionToken: string;
        sessionTtlDays: number;
        redirectPath: string;
    ...
    private loginWithAppleProfile;
    private appleKeysCache;
    private getAppleSigningKeys;
    private getAppleAllowedAudiences;
    private verifyAppleCredential;
